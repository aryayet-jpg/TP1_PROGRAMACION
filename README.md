...
El sistema desarrollado es una aplicación por consola que permite analizar el estado de un servidor a partir de múltiples variables de entrada.
...
El análisis se realiza mediante reglas lógicas aplicadas sobre datos solicitados al usuario.
...
2. Si el valor de disco es menor a 30 o procesos es mayor a 80, entonces se indica: **Mantenimiento urgente** - **Se utiliza OR y 2 variables**
3. Si NOT firewall activo (por lo tanto, firewall inactivo), entonces se indica: **Riesgo de seguridad** - **Se utiliza NOT y 1 variable**
4. Si los valores de CPU y RAM estan entre 40 y 70, entonces se indica: **Estado normal** -
